...
export default class CustomTabBar extends Component {
  constructor(props) {
    ...
    if (pages.length > 0) {
      ...
      initialActive = pathMap[currentPath] !== undefined ? pathMap[currentPath] : 0
      console.log('[TabBar] constructor - initialActive:', initialActive, 'from path:', currentPath)
    }
  ...
  updateActive = () => {
    ...
    console.log('[TabBar] updateActive - mapped active:', active, 'current state.active:', this.state.active)
  ...
  render() {
    ...
    return (
      <Tabbar value={this.state.active} onChange={this.onChange} className="custom-tabbar" fixed>
        <Tabbar.TabItem value={0} icon={<HomeOutlined />}>首页</Tabbar.TabItem>
        <Tabbar.TabItem value={1} icon={<ChatOutlined />}>AI聊天</Tabbar.TabItem>
        <Tabbar.TabItem value={2} icon={<ManagerOutlined />}>我的</Tabbar.TabItem>
      </Tabbar>
    )
  }
}
